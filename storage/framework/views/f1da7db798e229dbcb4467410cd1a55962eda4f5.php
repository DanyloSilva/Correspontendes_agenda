...
<div class="container" style="margin-top: 30px; padding: 20px">
    <?php $__env->startSection("menu-topo"); ?>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="/register"><i class="fas fa-plus"></i> Novo usuário</a></li>
...
<?php /**PATH C:\xampp\htdocs\Agenda\laravel-agenda\resources\views/app.blade.php ENDPATH**/ ?>