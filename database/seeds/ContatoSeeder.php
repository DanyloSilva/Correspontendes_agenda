    ...
    public function run()
    {
        ...
        foreach (range(1, 200) as $i) {
            ...
            $data = [
                ...
                'telefone1' => $faker->unique()->phoneNumber,
                'telefone2' => $faker->unique()->phoneNumber,
                'telefone3' => $faker->unique()->phoneNumber,
                'telefone4' => $faker->unique()->phoneNumber,
                'telefone5' => $faker->unique()->phoneNumber,
                'telefone6' => $faker->unique()->phoneNumber,
                'telefone7' => $faker->unique()->phoneNumber,
                'telefone8' => $faker->unique()->phoneNumber,
                'telefone9' => $faker->unique()->phoneNumber,
